                                ...
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input name="group_name" type="text" class="form-control" id="validationCustomUsername"
                                                placeholder="{{ __('messages.ln68')}}" required>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <input name="permissions[]" class="form-check-input position-static"
                                                                            type="checkbox" id="blankCheckbox"
                                                                    value="{{ $module->id }}-1">
                                                                    </div>
                                                                </td>
