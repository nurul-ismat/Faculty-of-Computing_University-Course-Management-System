        ...
        <div class="container-fluid dashboard-content">
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">{{__('messages.ln250')}}</h2>
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/utm-admin"
                                            class="breadcrumb-link">{{__('messages.ln1')}}</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">{{__('messages.ln250')}}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12 offset-md-2">
                    <div class="card">
                        <h4 class="card-header text-success">{{ __('messages.ln250')}} </h4>
                        <div class="card-body">
                            <form action=" {{ route('project_proposal.store') }} " method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-2">
                                        <div class="input-group">
                                            ...
                                            <input name="title" type="text" class="form-control"
                                                placeholder="{{__('messages.title')}}" focus>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h4 class="card-header text-success"> {{ __('messages.ln251')}}&nbsp;({{$data->count}}) </h4>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> 
                                            @foreach($data->courses as $course)
                                                @if($course->id == $projectproposal->course_name)
                                                    {{ $course->course_name }}
                                                @endif
                                            @endforeach
                                            </td>
                                            ...
                                            <td>
                                                @if($projectproposal->status == 1)
                                                <button class="btn btn-success btn-sm">Publish</button>
                                                @elseif($projectproposal->status == 0)
                                            ...
                                            <form action=" {{ route('project_proposal.destroy',[$projectproposal->id]) }} " method="POST">
                                                @csrf
                                                @method("DELETE")
